...
export function grid(
  ...
  // Matrix property contains two-dimensional grid of created sprites.
  // Here it's just been initialized.
  container.matrix = []
  for (let i = 0; i < columns; i++) {
  	container.matrix.push([])
  	for (let j = 0; j < rows; j++)
  		container.matrix[i].push(null)
  }
